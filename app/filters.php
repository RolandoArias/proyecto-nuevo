...
{
	$user = Sentry::getUser();
    $company = Sentry::findGroupByName('Companies');
...
Route::filter('guest', function()
{
	if (Sentry::check())
	{
	    ...
	    elseif ($user->inGroup($company)) return Redirect::intended('/company');	    
...
Route::filter('redirectCompany', function()
{
	if (Sentry::check())
	{
		$user = Sentry::getUser();
	    ...
	    if ($user->inGroup($company)) return Redirect::intended('company');
	}
});
